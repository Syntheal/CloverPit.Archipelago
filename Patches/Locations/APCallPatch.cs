...
public static class APCallPatch
{
    ...
    [HarmonyPostfix]
    [HarmonyPatch("AFunc_OnPick_HolyGeneric_SymbolsMultiplier3")]
    public static void Postfix_OnPick_HolyGeneric_SymbolsMultiplier3(AbilityScript ability)
    {
        doLocation(ability);
    }

    [HarmonyPostfix]
    [HarmonyPatch("AFunc_OnPick_HolyGeneric_PatternsMultiplier1")]
    public static void Postfix_OnPick_HolyGeneric_PatternsMultiplier1(AbilityScript ability)
    {
        doLocation(ability);
    }

    [HarmonyPostfix]
    [HarmonyPatch("AFunc_OnPick_HolyGeneric_ReduceCharmsChargesNeeded")]
    public static void Postfix_OnPick_HolyGeneric_ReduceCharmsChargesNeeded(AbilityScript ability)
    {
        doLocation(ability);
    }

    [HarmonyPostfix]
    [HarmonyPatch("AFunc_OnPick_HolyGeneric_ModifyAllStoreCharmsMake1Free")]
    public static void Postfix_OnPick_HolyGeneric_ModifyAllStoreCharmsMake1Free(AbilityScript ability)
    {
        doLocation(ability);
    }

    [HarmonyPostfix]
    [HarmonyPatch("AFunc_OnPick_HolyGeneric_PatternsRepetitionIncrease")]
    public static void Postfix_OnPick_HolyGeneric_PatternsRepetitionIncrease(AbilityScript ability)
    {
        doLocation(ability);
    }

    [HarmonyPostfix]
    [HarmonyPatch("AFunc_OnPick_SpawnSacredCharm")]
    public static void Postfix_OnPick_SpawnSacredCharm(AbilityScript ability)
    {
        doLocation(ability);
    }

    [HarmonyPostfix]
    [HarmonyPatch("AFunc_OnPick_HolyPatternsValue_3OrLessElements")]
    public static void Postfix_OnPick_HolyPatternsValue_3OrLessElements(AbilityScript ability)
    {
        doLocation(ability);
    }

    [HarmonyPostfix]
    [HarmonyPatch("AFunc_OnPick_HolyPatternsValue_4OrMoreElements")]
    public static void Postfix_OnPick_HolyPatternsValue_4OrMoreElements(AbilityScript ability)
    {
        doLocation(ability);
    }
}