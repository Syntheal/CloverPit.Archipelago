...
public static class APItemMapping
{
    private static readonly Dictionary<string, PowerupScript.Identifier> Map =
        new Dictionary<string, PowerupScript.Identifier>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Charm: Grandma's Purse", PowerupScript.Identifier.GrandmasPurse },
            ...
            { "Charm: Voicemail", PowerupScript.Identifier.VoiceMailTape },
            ...
            { "Charm: CloverPot", PowerupScript.Identifier.CloverPot },
            { "Charm: CloverPet", PowerupScript.Identifier.CloverPet },
            { "Charm: CloverField", PowerupScript.Identifier.CloversLandPatch },
            ...
            { "Charm: 7 Sins Stone", PowerupScript.Identifier.SevenSinsStone },
            { "Charm: Necklace", PowerupScript.Identifier.Necklace },
            { "Charm: CloverBell", PowerupScript.Identifier.CloverBell },
            ...
            { "Charm: Magical Tomato", PowerupScript.Identifier.MysticalTomato },
